...
const SupportTundraPage = () => {
    ...
    const Questions = [
        ...
        {question: "Finance", answer: "We now have finance! - super passionate team that will you the deal done. Independent Contractor so he only makes money if he gets deal across the line."},
