...
export default function FeatureBar ({grades, activeGrade, activeColor, updateActiveColor, updateActiveGrade, activeBed, updateActiveBed, price}){
    ...
    return(
        <CenterLeft>
                ...
                <p className="infoText">To put a 75% deposit down securing your custom Tundra build for 2023, please click the button below for more info at our payment gateway.</p>
